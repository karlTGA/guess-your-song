    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", padding: 16 }}>
            <Card style={{ width: "100%", maxWidth: 400 }}>
                <Title level={3} style={{ textAlign: "center" }}>Guess Your Song</Title>
                {error && <Alert message={error} type="error" style={{ marginBottom: 16 }} />}
                <Form layout="vertical" onFinish={handleJoin}>
                    <Form.Item label="Game Code" name="code" rules={[{ required: true, message: "Enter the game code" }]}>
                        <Input placeholder="Enter 6-character code" maxLength={6} style={{ textTransform: "uppercase" }} />
                    </Form.Item>
                    <Form.Item label="Your Name" name="playerName" rules={[{ required: true, message: "Enter your name" }]}>
