...
import { SoundOutlined, UnorderedListOutlined, PlayCircleOutlined } from "@ant-design/icons";
...
function AdminLayout() {
  ...
  const menuItems = [
    { key: "songs", icon: <SoundOutlined />, label: <Link to="/admin/songs">Songs</Link> },
    { key: "playlists", icon: <UnorderedListOutlined />, label: <Link to="/admin/playlists">Playlists</Link> },
    { key: "sessions", icon: <PlayCircleOutlined />, label: <Link to="/admin/sessions">Sessions</Link> },
  ];
